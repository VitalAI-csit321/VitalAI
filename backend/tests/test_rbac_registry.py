...
def test_total_route_count():
    ...
    # 43 real application routes as of this writing (42 + GET /api/v1/intake,
    # the list endpoint), confirmed via a direct app.routes walk before this
    # test was written. Bump deliberately when a route is added or removed;
    # an unexpected change here means the walker itself regressed (e.g.
